...
如果侧重速度，可以使用Cosmos Predict2 2b，密集细节表现差一些，在3070m生成1536x1024图片用时74秒。由于光照和速度优势，目前作为主力绘画模型。对速度要求更高的话可以用Dreamshaper XL等基于SDXL Lightning的模型，生成1024x1024的图片要6.5秒。
