...
开源视频模型效果最好的是Wan2.1 14b FusionX，整合了速度和画质优化方法，用8步生成视频画质略高于原版。使用WanVideoWrapper运行时8g显存能生成33帧1152x640视频，用时约9分钟。WanVideoWrapper显存优化比Comfyui官方工作流差，但提供了模块化的VACE模型并且有量化版本。使用VACE模型时8g显存能生成29帧1152x640视频，用时约10分钟。
